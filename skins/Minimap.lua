...
Minimap:HookScript("OnEvent", function(self, event, ...)
    if (event == "PLAYER_ENTERING_WORLD") then
        ...
        Minimap:SetPoint("CENTER", MinimapCluster, "TOP", 10, -88)
        ...
        if (ExpansionLandingPageMinimapButton:GetNormalTexture():GetAtlas() == "dragonflight-landingbutton-up") then
            ExpansionLandingPageMinimapButton:SetScale(0.80)
            ExpansionLandingPageMinimapButton:ClearAllPoints()
            ExpansionLandingPageMinimapButton:SetPoint("TOPLEFT", 55, -174)
        ...
        GameTimeFrame:SetSize(45, 45)
        GameTimeFrame:ClearAllPoints()
        GameTimeFrame:SetPoint("TOPRIGHT", Minimap, "TOPRIGHT", 8, 8)
        ...
        MinimapCluster.IndicatorFrame.MailFrame:SetPoint("BOTTOMRIGHT", Minimap, "BOTTOMRIGHT", -1, 20)
        MinimapCluster.IndicatorFrame.MailFrame:SetSize(23, 23)
        ...
        MiniMapMailIcon:SetTexture("Interface\\Icons\\INV_Letter_15")
        MiniMapMailIcon:ClearAllPoints()
        MiniMapMailIcon:SetPoint("TOPLEFT", MinimapCluster.IndicatorFrame.MailFrame, "TOPLEFT", 6, -5)
        MiniMapMailIcon:SetDrawLayer("ARTWORK", 0)
