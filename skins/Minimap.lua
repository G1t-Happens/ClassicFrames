...
MinimapBorder:SetTexture("Interface\\AddOns\\ClassicFrames\\frames\\MiniMap\\UI-Minimap-Border")
...
MinimapNorthTag:SetTexture("Interface\\AddOns\\ClassicFrames\\frames\\MiniMap\\CompassNorthTag", "OVERLAY")
