...
local function SkinFrame(frame)
    ...
    FrameHealthBar.UnconsciousText:SetParent(frame.TargetFrameContainer)
    ...
    if (frame.totFrame) then
        ...
        frame.totFrame.FrameTexture:SetPoint("TOPLEFT", 1, 0)
        ...
        frame.totFrame.HealthBar:SetSize(45, 8)
        ...
        frame.totFrame.ManaBar:SetSize(45, 8)
