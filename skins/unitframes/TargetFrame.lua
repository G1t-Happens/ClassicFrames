...
local function SkinFrame(frame)
    ...
    if (frame.totFrame) then
        ...
        frame.totFrame.HealthBar:SetSize(47, 7)
        frame.totFrame.HealthBar:ClearAllPoints()
        frame.totFrame.HealthBar:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", 6, -1)
        frame.totFrame.HealthBar:SetFrameLevel(1)
        frame.totFrame.HealthBar.DeadText:SetParent(frame.totFrame)

        frame.totFrame.ManaBar:SetSize(47, 7)
        frame.totFrame.ManaBar:ClearAllPoints()
        frame.totFrame.ManaBar:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", 6, -9)
