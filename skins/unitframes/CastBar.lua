...
local function ChangeEvokerBars(self)
    for i = 1, self.NumStages - 1, 1 do
        ...
        if chargeTier then
            ...
            chargeTier.Normal:SetTexture("Interface\\AddOns\\ClassicFrames\\textures\\UI-StatusBar")
            chargeTier.Disabled:SetDesaturated(true)
            chargeTier.Disabled:SetTexture("Interface\\AddOns\\ClassicFrames\\textures\\UI-StatusBar")
            chargeTier.Glow:SetDesaturated(true)
            chargeTier.Glow:SetTexture("Interface\\AddOns\\ClassicFrames\\textures\\UI-StatusBar")
            if i == 1 then
