...
local function SetLookReplacementPlayer(self, event, ...)
    if (PlayerCastingBarFrame.attachedToPlayerFrame) then
        ...
        self.Border:SetTexture("Interface\\AddOns\\ClassicFrames\\frames\\CastingBar\\UI-CastingBar-Border-Small")
        self.Border:SetSize(0, 49)
        self.Border:ClearAllPoints()
        self.Border:SetPoint("TOPLEFT", -23, 20)
        self.Border:SetPoint("TOPRIGHT", 23, 20)
        self.BorderShield:SetTexture("Interface\\AddOns\\ClassicFrames\\frames\\CastingBar\\UI-CastingBar-Small-Shield")
        ...
        self:SetSize(190, 10)
        self.Background:SetColorTexture(0, 0, 0, 0.5)
        self.Border:SetTexture("Interface\\AddOns\\ClassicFrames\\frames\\CastingBar\\UI-CastingBar-Border")
...
local function SetLookReplacementTargetFocus(self)
    ...
    self.BorderShield:ClearAllPoints()
    self.BorderShield:SetPoint("TOPLEFT", -29, 20)
    self.BorderShield:SetPoint("TOPRIGHT", 21, 20)
